...
function getInt64(byteOffset, s, defaultMask) {
    ...
    if (defaultMask !== undefined) {
        const lo = ds.segment.getUint32(ds.byteOffset + byteOffset) ^ defaultMask.getUint32(0, true);
        const hi = ds.segment.getUint32(ds.byteOffset + byteOffset + 4) ^ defaultMask.getUint32(4, true);
        TMP_WORD.setUint32(constants_1.NATIVE_LITTLE_ENDIAN ? 0 : 4, lo, constants_1.NATIVE_LITTLE_ENDIAN);
        TMP_WORD.setUint32(constants_1.NATIVE_LITTLE_ENDIAN ? 4 : 0, hi, constants_1.NATIVE_LITTLE_ENDIAN);
        return TMP_WORD.getBigInt64(0, constants_1.NATIVE_LITTLE_ENDIAN);
    }
...
function getUint64(byteOffset, s, defaultMask) {
    ...
    if (defaultMask !== undefined) {
        ...
        TMP_WORD.setUint32(constants_1.NATIVE_LITTLE_ENDIAN ? 0 : 4, lo, constants_1.NATIVE_LITTLE_ENDIAN);
        TMP_WORD.setUint32(constants_1.NATIVE_LITTLE_ENDIAN ? 4 : 0, hi, constants_1.NATIVE_LITTLE_ENDIAN);
        return TMP_WORD.getBigUint64(0, constants_1.NATIVE_LITTLE_ENDIAN);
    }
...
function setInt64(byteOffset, value, s, defaultMask) {
    ...
    const ds = getDataSection(s);
    if (defaultMask !== undefined) {
        TMP_WORD.setBigInt64(0, value, constants_1.NATIVE_LITTLE_ENDIAN);
        const lo = TMP_WORD.getUint32(constants_1.NATIVE_LITTLE_ENDIAN ? 0 : 4, constants_1.NATIVE_LITTLE_ENDIAN) ^ defaultMask.getUint32(0, true);
        const hi = TMP_WORD.getUint32(constants_1.NATIVE_LITTLE_ENDIAN ? 4 : 0, constants_1.NATIVE_LITTLE_ENDIAN) ^ defaultMask.getUint32(4, true);
        ds.segment.setUint32(ds.byteOffset + byteOffset, lo);
        ds.segment.setUint32(ds.byteOffset + byteOffset + 4, hi);
        return;
    }
...
function setUint64(byteOffset, value, s, defaultMask) {
    ...
    const ds = getDataSection(s);
    if (defaultMask !== undefined) {
        TMP_WORD.setBigUint64(0, value, constants_1.NATIVE_LITTLE_ENDIAN);
        const lo = TMP_WORD.getUint32(constants_1.NATIVE_LITTLE_ENDIAN ? 0 : 4, constants_1.NATIVE_LITTLE_ENDIAN) ^ defaultMask.getUint32(0, true);
        const hi = TMP_WORD.getUint32(constants_1.NATIVE_LITTLE_ENDIAN ? 4 : 0, constants_1.NATIVE_LITTLE_ENDIAN) ^ defaultMask.getUint32(4, true);
        ds.segment.setUint32(ds.byteOffset + byteOffset, lo);
        ds.segment.setUint32(ds.byteOffset + byteOffset + 4, hi);
