 ...
 */
export declare function getInt64(byteOffset: number, s: Struct, defaultMask?: DataView): bigint;
/**
 ...
 * @returns {bigint} The value.
 */
export declare function getUint64(byteOffset: number, s: Struct, defaultMask?: DataView): bigint;
/**
 ...
 * @returns {void}
 */
export declare function setInt64(byteOffset: number, value: bigint, s: Struct, defaultMask?: DataView): void;
/**
 ...
 * @returns {void}
 */
export declare function setUint64(byteOffset: number, value: bigint, s: Struct, defaultMask?: DataView): void;
/**
